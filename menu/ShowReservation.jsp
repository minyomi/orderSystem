                          ...
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tbody>
                                 <%
                                    ...
                                    Iterator<Reservation> it=Rs.iterator();
                                    while(it.hasNext())
                                    {
                                    	...
                                    	String when=R.getWhen();
                                    	Timestamp time=R.getDatetime();
                                     %>
                              <tr>
                                  <td class="hidden-phone"><%=name %></td>
                                  <td class="hidden-phone"><%=phone %></td>	                                 
                                  <td class="hidden-phone"><%=number %></td>  
                                  <td class="hidden-phone"><%=when %></td>                                 
                                  <td class="hidden-phone"><%=time %></td> 
                                  <td><a href="ReservationOver?id=<%=id%>"><button type="button" class="btn btn-shadow btn-danger">完成</button></a>  </td>
