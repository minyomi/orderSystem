...
<jsp:include page="jsphead1.jsp"></jsp:include>
     ...
     %>
                              ...
                              <a href="AcceptingOrder?id=<%=order.getId()%>"><button type="button" class="btn btn-shadow btn-primary">受理订单</button></a>
                               <a href="InvoicingOrder?id=<%=order.getId()%>"><button type="button" class="btn btn-shadow btn-success">打印订单</button></a>
                              <a href="CancelingOrder?id=<%=order.getId()%>"><button type="button" class="btn btn-shadow btn-info">撤销订单</button></a>
