                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form role="form" class="form-horizontal tasi-form" action="AddDishItem" method="post">
                                  <div class="form-group has-success">
                                   ...
                                   <div class="form-group has-success">
                                      <label class="col-lg-2 control-label">所属菜单</label>
                                      ...
                                      %>
                                      <option value="<%=menu.getName()%>"><%=menu.getName()%></option>
								    ...
								    <div class="form-group has-error">
                                      ...
                                      <div class="col-lg-10">
                                          <input type="text" placeholder="" id="f-name" class="form-control" name="price">
                                      </div>
									  </div>
                                     ...
                                     <label class="col-lg-2 control-label">菜品图片</label>
                                      ...
                                      <div class="col-lg-10">
                                          <input type="text" placeholder="" id="f-name" class="form-control" name="description">
                                      </div>
                                  </div>            
                                  <div class="form-group">
