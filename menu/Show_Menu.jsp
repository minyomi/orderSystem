              ...
              <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tr>
                                ...
                                <form role="form" class="form-horizontal tasi-form" action="ChangeMenu" method="post">
                                <input type="hidden" name="id" value="<%=menu.getId()%>">
                                  <div class="form-group has-success">
								   ...
								   <div class="form-group has-error">
                                      <label class="col-lg-2 control-label">菜单类别</label>
                                      <div class="col-lg-10">
                          ...
                          <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>    
                                     ...
                                     <a href="DeleteMenu?id=<%=menu.getId()%>"><button class="btn btn-danger btn-xs tooltips" data-original-title="删除"><i class="icon-trash "></i></button>	</a>								
                                  </td>
                              </tr>
