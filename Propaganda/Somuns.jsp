  ...
  <body>
      ...
      <div class="container templatemo_container">
        <div class="row">
          <div class="col-sm-3 col-md-3">
            <div class="logo">
              <a  href="#"><img src="images/1.jpg" alt="logo"></a>
            </div>
          </div>
          <div class="col-sm-9 col-md-9 templatemo_col9">
            ...
            <nav class="mainMenu">
              <ul class="nav">
                <li><a class="menu" href="#templatemo_home">主页</a></li>
                <li><a class="menu" href="#templatemo_about">简介</a></li>
                <li><a class="menu" href="#templatemo_portfolio">特色菜图片</a></li>               
                <li><a class="menu" href="#templatemo_footer">预定座位</a></li>
              </ul>
            </nav>
            </div>
          </div>
    ...
    <!-- end menu -->
      	<div  id="slider"  class="nivoSlider templatemo_slider">
			...
			<a href="#"><img src="images/slider/2.png" alt="slide 2" /></a>
	...
	<div class="container">
        	...
        	<div class="item project-post">
						<div class="templatemo_about_box">
                        	<div class="square_coner">
                     		   <span class="texts-a"><i class="fa fa-male"></i></span>
                      	  </div>
                     	  <h4> 餐饮店规模<h4>
						  </div>
						<div class="col-xs-12 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">
								<p>已在20多个城市拥有连锁店，餐饮店共有50多家。员工200多人。</p>
							</div>
						</div>
					</div>
        </div>
        ...
        <div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12 templatemo_margintop10">
        	<div class="item project-post">
						<div class="templatemo_about_box">
                        	<div class="square_coner">
                     		   <span class="texts-a"><i class="fa fa-phone"></i></span>
                      	  </div>
                     	   订餐电话</div>
						<div class="col-xs-6 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">
    ...
    <div class="templatemo_portfolio" id="templatemo_portfolio">
            ...
            <a class="btn btn-large btn-primary" href="#">查看更多</a>
    </div>
    <!--Our Portfolio End-->
    ...
    <!--Footer Start-->
    <div class="templatemo_footer" id="templatemo_footer">
    	<div class="container">
      <div class="col-lg-6">
            <h2>联系方式</h2>
            	<span class="left col-xs-1 fa fa-map-marker"></span>
                <span class="right col-xs-11">湖北省武汉市武昌区徐东大街</span>
                <div class="clear height10"></div>
                <span class="left col-xs-1 fa fa-phone"></span>
                <span class="right col-xs-11">1234567</span>
                <div class="clear height10"></div>
                <span class="left col-xs-1 fa fa-envelope"></span>
                <span class="right col-xs-11">1234567@example.com</span>
                <div class="clear height10"></div>
                <span class="left col-xs-1 fa fa-globe"></span>
                <span class="right col-xs-11">www.xxxxxx.com</span>
                <div class="clear"></div>
            </div>
		
			<div class="col-lg-6">
		    <h2>预定座位</h2>
            	<form role="form" class="form-horizontal tasi-form" action="/cn.mos2/Reservation">
                                  <div class="form-group has-success">
                                      ...
                                      <div class="form-group has-success">
                                      <label class="col-lg-2 control-label">就餐时间</label>
                                      <div class="col-lg-10">
                                          <input type="text" placeholder=""  class="form-control" name="when">                                          
                                      </div>
                                  </div> 
